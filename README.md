...
# Megatrust Solutions Team Work for Disaster Management, Climate,Change and More than Solutions with SmartCity Integrated for better live Citizen in the Global Live.
...
### GallerAI just like a vehicle, one of which is part of the Crisis Center Development Project and platform technology that will solve the problem of disaster mitigation and sustainable disaster management and its effects with various consequences. What we are focusing on is the construction of a crisis center as a center for disaster control and caring for the main victims, children. -children to be given supplies so that the period of going through trauma does not result in other physical impacts. Problems that we hope can be solved with Megatrust Solutions, because with IBM technology everything can be done with perfection in accordance. Moreover, it is now necessary to adopt a change management perspective. In the field of information technology (IT), this is a practice designed to minimize disruption to IT operations while making changes to critical systems and services. A good change management process is also important for information security because it helps organizations protect their most sensitive assets during changes to systems, processes, and technology,

MEGATRUST RESPONSE and disaster mitigation solutions and their impacts.
